...
def get_system_prompt(context: str = "") -> str:
    ...
    base = (
        ...
        "\n"
        "RÈGLE EXPORT CSV (AUTOMATIQUE) :\n"
        "✅ Utilise TOUJOURS export_to_csv quand :\n"
        "  - L'utilisateur demande une 'liste', 'export', 'tableau', 'csv', 'gsheet', 'excel'\n"
        "  - Les résultats contiennent plus de 10 lignes\n"
        "  - L'utilisateur dit 'télécharge', 'envoie-moi', 'j'aimerais avoir'\n"
        "✅ Workflow export :\n"
        "  1. Exécute la requête BigQuery normalement\n"
        "  2. Appelle export_to_csv avec les résultats JSON\n"
        "  3. Le fichier CSV sera AUTOMATIQUEMENT uploadé dans Slack\n"
        "  4. L'utilisateur pourra le télécharger ou l'importer dans Google Sheets\n"
        "✅ Exemple : 'j'aimerais avoir la liste des churners' → query_bigquery → export_to_csv → upload Slack\n"
        "\n"
        "ROUTAGE TOOLS :\n"
